...
А знаешь сколько стоит месяц в клубе? **${subscriptionAmount} р.** Нет, это не первый взнос рассрочки. Это вся стоимость
...
💎 *За ${subscriptionAmount}₽/месяц получаешь:*
✨ Ежедневные уроки от профи
